...
namespace HiQoDataGenerator.Tests.HiQoDataGenerator.Core.Services
{
    public class DatasetsTest
    {
        ...
        {
            _datasetRepositoryMock.Setup(rep => rep.GetAllAsync()).Returns(_datasets.AsQueryable());
        ...
        private void ConfigureDefinedDatasetRepositoryMock(Mock<IDefinedDatasetRepository> repositoryMock)
        {
            ...
            repositoryMock.Setup(rep => rep.GetValuesByDatasetIdAsync(1)).Returns(_definedDatasetValues.AsQueryable());
        }
        ...
        private void ConfigureCustomDatasetRepositoryMock(Mock<ICustomDatasetRepository> repositoryMock)
        {
            ...
            repositoryMock.Setup(rep => rep.GetValuesByDatasetIdAsync(1)).Returns(_customDatasetValues.AsQueryable());
        }
